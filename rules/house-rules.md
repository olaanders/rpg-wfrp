...
* _Rulla om_ - Du får rulla om ett misslyckat test mot en färdighet eller grundegenskap. Endast ett FP får användas för 
ett misslyckat test.
* _Extra Parering/Ducka_ - Genom att spendera ett FP får du en extra parering eller ducka vilket gör att du får 
parera/ducka mer än en gång per SR (vilket normalt sett är förbjudet).
* _Extra Initiative_ - Du får en extra T10 att lägga till till ditt _Initiative_.
* _Extra Half Action_ - För ett FP får du en extra _Half Action_ att använda under en SR.
* _Slå om Damage_ - Du får slå om din skadetärning.
